...
<head>
  ...
  <title>Program Scale Analytics</title>
  ...
  <link rel="stylesheet" href="<?= app_path('/admin/css/pages/stat_scale.css') ?>">
</head>
...
<body>
  ...
  <main class="main-content page-padded">
    ...
    <div class="welcome-card section-spaced">
      <h3>Program Scale Analytics</h3>
      <p class="muted-note">Number of verified programs by scale across all libraries.</p>
    </div>
    ...
    <!-- TABLE -->
    <table id="scaleTable" class="display nowrap table-full">
...
<script src="<?= app_path('/admin/javascript/pages/stat_scale.js') ?>"></script>
