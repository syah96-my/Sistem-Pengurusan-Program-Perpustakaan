...
<head>
  ...
  <title>Program Target Analytics</title>
  ...
  <link rel="stylesheet" href="<?= app_path('/admin/css/pages/stat_program_target.css') ?>">
</head>
...
<body>
  ...
  <main class="main-content page-padded">
    ...
    <div class="welcome-card section-spaced">
      <h3>Program Target Analytics</h3>
      <p class="muted-note">Number of verified programs by target group across all libraries.</p>
    </div>
    ...
    <!-- TABLE -->
    <table id="targetTable" class="display nowrap table-full">
...
<script src="<?= app_path('/admin/javascript/pages/stat_program_target.js') ?>"></script>
