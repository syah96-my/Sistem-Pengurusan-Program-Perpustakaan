...
<head>
  ...
  <title>Program Mode Analytics</title>
  ...
  <link rel="stylesheet" href="<?= app_path('/admin/css/pages/stat_program_mod.css') ?>">
</head>
...
<body>
  ...
  <main class="main-content page-padded">
    ...
    <div class="welcome-card section-spaced">
      <h3>Program Mode Analytics</h3>
      <p class="muted-note">Number of verified programs by mode (physical, online, hybrid).</p>
    </div>
    ...
    <!-- TABLE -->
    <table id="modeTable" class="display nowrap table-full">
...
<script src="<?= app_path('/admin/javascript/pages/stat_program_mod.js') ?>"></script>
