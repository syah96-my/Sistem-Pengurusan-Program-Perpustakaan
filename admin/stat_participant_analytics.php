...
<head>
  ...
  <link rel="stylesheet" href="<?= app_path('/admin/css/pages/stat_participant_analytics.css') ?>">
</head>
...
<body>
  ...
  <main class="main-content page-padded">
    ...
    <div class="welcome-card section-spaced">
      ...
      <p class="muted-note">Participant distribution by library.</p>
    </div>
    ...
    <!-- TABLE -->
    <table id="partTable" class="display nowrap table-full">
      <thead>
        <tr>
          <th>Library</th>
          <th>Total</th>
...
<script src="<?= app_path('/admin/javascript/pages/stat_participant_analytics.js') ?>"></script>
